...
|`jnosql.arangodb.serializer`
|Define the list of deserializer classes that will be used by ArangoDB. These classes must extend `com.fasterxml.jackson.databind.JsonSerializer`. Example: jnosql.arangodb.deserializer.1=my.package.MyCustomSerializer

|`jnosql.arangodb.deserializer`
| Define the list of deserializer classes that will be used by ArangoDB. These classes must extend `com.fasterxml.jackson.databind.JsonDeserializer`. Example: jnosql.arangodb.deserializer.1=my.package.MyCustomDeserializer
|===
